...
export declare const setFillingColor: (color: Color) => import("../../src/core/operators/PDFOperator").default;
export declare const setStrokingColor: (color: Color) => import("../../src/core/operators/PDFOperator").default;
