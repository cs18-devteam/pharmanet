...
exports.renderAddUsersView = async (req, res) => {
  ...
  return response(
    res,
    view("admin/addUsers", {
      adminId: req.adminId || req.params?.adminId,
      id: req.adminId || req.params?.adminId,
    }),
    200
  );
};
...
exports.createUser = catchAsync(async (req, res) => {
  ...
  await ActivityLogService.logActivity(
    ...
    "CREATE", // ACTION
    "user", // CATEGORY
    "Created user account", // DESCRIPTION
    userData.email, // ENTITY NAME
    newUser.insertId // ENTITY ID
  );
